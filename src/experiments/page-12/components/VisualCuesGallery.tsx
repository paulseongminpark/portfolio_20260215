  ...
  return (
    <div className="vcg">
      ...
      <div className="vcg-main">
        <img src={`${P}/visual cues 1.jpeg`} alt="" loading="lazy" />
      </div>
      ...
      <div className="vcg-sub">
        <img src={`${P}/visual cues 2.jpeg`} alt="" loading="lazy" />
      </div>

      {/* Mockups 3,4 — 3 left, 4+caption right */}
      <div className="vcg-mockup">
        <div className="vcg-mockup-left">
          <img src={`${P}/visual cues 3 logo mock up.jpg`} alt="" loading="lazy" />
        </div>
        <div className="vcg-mockup-right">
          <img src={`${P}/visual cues 4 logo mock up 2.jpg`} alt="" loading="lazy" />
      ...
      <div className="vcg-center">
        <div className="vcg-palette-stack">
          <img src={`${P}/visual cues 5 color palette 1.PNG`} alt="" loading="lazy" />
          <img src={`${P}/visual cues 6 color palette 2.png`} alt="" loading="lazy" />
          <img src={`${P}/visual cues 7 color palette 3.png`} alt="" loading="lazy" />
        </div>
        <p className="vcg-caption-center" style={{ fontFamily: F }}>
      ...
      <div className="vcg-center">
        <div className="vcg-final">
          <figure className="vcg-fig vcg-square">
            <img src={`${P}/visual cues 8 logo.jpg`} alt="" loading="lazy" />
            <figcaption className="vcg-caption-left" style={{ fontFamily: F }}>
              최종 로고 및 포스터 작업
            </figcaption>
          </figure>
          <figure className="vcg-fig">
            <img src={`${P}/visual cues 9 logo.jpg`} alt="" loading="lazy" />
          </figure>
        </div>
      </div>
